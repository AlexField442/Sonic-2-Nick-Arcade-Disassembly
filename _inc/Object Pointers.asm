...
ObjID_HPZWaterfall:	objptr Obj_HPZWaterfall	; Waterfall from Hidden Palace Zone
...
ObjID_GHZWall:		objptr Obj44		; (S1) Unbreakable wall
			dc.l ObjNull
			dc.l ObjNull
			dc.l ObjNull		; (S1) SYZ Bumper (pointer removed)
...
ObjID_BBat:		objptr Obj_BBat		; BBat from HPZ
...
ObjID_LZBoss:		objptr ObjNull		; (S1) LZ boss (pointer AND code removed)
			dc.l ObjNull
ObjID_Checkpoint:	objptr Obj_Checkpoint	; Checkpoint
			dc.l ObjNull
			dc.l ObjNull
