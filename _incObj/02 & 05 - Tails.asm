...
; ===========================================================================
; off_10C4E: Obj02_Index:
Tails_Index:	dc.w Tails_Init-Tails_Index		; 0
		dc.w Tails_Main-Tails_Index		; 2
		dc.w Obj02_Hurt-Tails_Index		; 4
		dc.w Obj02_Dead-Tails_Index		; 6
		dc.w Obj02_ResetLevel-Tails_Index	; 8
; ===========================================================================
; loc_10C58: Obj02_Init:
Tails_Init:
		addq.b	#2,routine(a0)
...
; ---------------------------------------------------------------------------
; loc_10CBC: Obj02_Control:
Tails_Main:
		bsr.w	Tails_Control
		btst	#0,(Player_override_flag).w	; is Tails interacting with another object that holds him in place or controls his movement somehow?
		bne.s	Tails_ControlsLock	; if yes, branch to skip Tails' control
		moveq	#0,d0
		move.b	status(a0),d0
		andi.w	#6,d0
		move.w	Tails_Modes(pc,d0.w),d1
		jsr	Tails_Modes(pc,d1.w)	; run Tails' movement code
; loc_10CDA: Obj02_ControlsLock:
Tails_ControlsLock:
		bsr.s	Tails_Display
...
loc_10CFC:
		...
		rts
; ===========================================================================
; off_10D02: Obj02_Modes:
Tails_Modes:	dc.w Obj02_MdNormal-Tails_Modes
		dc.w Obj02_MdJump-Tails_Modes
		dc.w Obj02_MdRoll-Tails_Modes
		dc.w Obj02_MdJump2-Tails_Modes
; ===========================================================================
; same as Sonic's...
...
; loc_10D1E: Obj02_Display:
.display:
		jsr	(DisplaySprite).l
; loc_10D24: Obj02_ChkInvinc:
Tails_ChkInvinc:
...
loc_10D54:
		...
		move.b	(a1,d0.w),d0
		jsr	(PlayMusic).l
; loc_10D62: Obj02_RmvInvin:
Tails_RmvInvin:
		move.b	#0,(Invincibility_flag).w
; loc_10D68: Obj02_ChkShoes:
Tails_ChkShoes:
...
loc_1134E:				; CODE XREF: Tails_LevelBoundaries+3Ej
		...
		bne.w	JmpTo2_KillSonic
		cmpi.w	#$2000,x_pos(a0)
		bcs.w	JmpTo2_KillSonic
...
; ---------------------------------------------------------------------------
; OST:
tt_tails_prev_anim:		equ $30		; byte
; ---------------------------------------------------------------------------
; Sprite_11D7E: Obj05:
Obj_TailsTails:
		moveq	#0,d0
...
; ===========================================================================
; off_11D8C: Obj05_Index:
TailsTails_Index:
		dc.w TailsTails_Init-TailsTails_Index
		dc.w TailsTails_Main-TailsTails_Index
; ===========================================================================
; loc_11D90: Obj05_Init:
TailsTails_Init:
		addq.b	#2,routine(a0)
		move.l	#Map_Tails,mappings(a0)
...
; loc_11DB8: Obj05_Main:
TailsTails_Main:
		move.b	(Sidekick+angle).w,angle(a0)
		...
		cmp.b	tt_tails_prev_anim(a0),d0
		beq.s	loc_11DE6
		move.b	d0,tt_tails_prev_anim(a0)
