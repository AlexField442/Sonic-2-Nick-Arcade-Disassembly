Mus85_HPZ_Header:
	...
	smpsHeaderVoice     Mus85_HPZ_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $02, $03

	smpsHeaderDAC       Mus85_HPZ_DAC
	smpsHeaderFM        Mus85_HPZ_FM1,	$F4, $11
	smpsHeaderFM        Mus85_HPZ_FM2,	$E8, $0B
	smpsHeaderFM        Mus85_HPZ_FM3,	$F4, $14
	smpsHeaderFM        Mus85_HPZ_FM4,	$F4, $18
	smpsHeaderFM        Mus85_HPZ_FM5,	$F4, $18
	smpsHeaderPSG       Mus85_HPZ_PSG1,	$D0, $06, $00, fTone_06
	smpsHeaderPSG       Mus85_HPZ_PSG2,	$E8, $07, $00, $00
	smpsHeaderPSG       Mus85_HPZ_PSG3,	$00, $05, $00, fTone_04
...
Mus85_HPZ_Jump02:
	...
	smpsModOff
	smpsAlterVol        $08
	smpsCall            Mus85_HPZ_Call09
	smpsCall            Mus85_HPZ_Call0A
...
Mus85_HPZ_FM4:
	smpsPan             panLeft, $00
	smpsAlterNote       $03
	smpsCall            Mus85_HPZ_Call01
	smpsAlterNote       $00

Mus85_HPZ_Jump00:
	smpsModSet          $01, $01, $01, $04
	smpsSetvoice        $02
	smpsCall            Mus85_HPZ_Call02
	smpsAlterVol        $FC
	dc.b	nD6, $02
	smpsCall            Mus85_HPZ_Call03
	smpsAlterVol        $04
	smpsJump            Mus85_HPZ_Jump00

Mus85_HPZ_Call02:
	smpsCall            Mus85_HPZ_Call0D
	dc.b	nA6, $30
	smpsCall            Mus85_HPZ_Call0D
...
Mus85_HPZ_Loop05:
	...
	smpsLoop            $00, $08, Mus85_HPZ_Loop05
	smpsPSGAlterVol     $FF

Mus85_HPZ_Jump03:
	dc.b	$02, nRst, nMaxPSG
	smpsJump            Mus85_HPZ_Jump03
