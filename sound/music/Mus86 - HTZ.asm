Mus86_HTZ_Header:
	...
	smpsHeaderVoice     Mus86_HTZ_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $02, $05

	smpsHeaderDAC       Mus86_HTZ_DAC
	smpsHeaderFM        Mus86_HTZ_FM1,	$F4, $0D
	smpsHeaderFM        Mus86_HTZ_FM2,	$F4, $0D
	smpsHeaderFM        Mus86_HTZ_FM3,	$F4, $13
	smpsHeaderFM        Mus86_HTZ_FM4,	$F4, $17
	smpsHeaderFM        Mus86_HTZ_FM5,	$F4, $17
	smpsHeaderPSG       Mus86_HTZ_PSG1,	$D0, $03, $00, $00
	smpsHeaderPSG       Mus86_HTZ_PSG2,	$D0, $03, $00, $00
	smpsHeaderPSG       Mus86_HTZ_PSG3,	$00, $03, $00, fTone_04
...
Mus86_HTZ_FM1:
	...
	smpsCall            Mus86_HTZ_Call06
	smpsSetvoice        $05
	smpsAlterNote       $FE
	smpsPan             panRight, $00
	smpsAlterVol        $03
	smpsAlterPitch      $F4
	smpsCall            Mus86_HTZ_Call04
	smpsAlterPitch      $0C
	smpsAlterVol        $FD
...
Mus86_HTZ_Loop0F:
	smpsCall            Mus86_HTZ_Call07
	smpsLoop            $00, $02, Mus86_HTZ_Loop0F
	smpsAlterVol        $02
	smpsJump            Mus86_HTZ_FM1
...
Mus86_HTZ_Loop07:
	dc.b	nG3, $06, nG4
	smpsLoop            $00, $05, Mus86_HTZ_Loop07
	dc.b	nG3
	smpsAlterVol        $03
	smpsNoteFill        $06

Mus86_HTZ_Loop0A:
	smpsCall            Mus86_HTZ_Call08

Mus86_HTZ_Loop08:
	dc.b	nG4, nG4, nD4, nD4, nF4, nF4, nD4, nD4
	smpsLoop            $00, $04, Mus86_HTZ_Loop08

Mus86_HTZ_Loop09:
	dc.b	nF4, nF4, nC4, nC4, nEb4, nEb4, nC4, nC4
	smpsLoop            $00, $04, Mus86_HTZ_Loop09
	smpsCall            Mus86_HTZ_Call08
	smpsLoop            $01, $02, Mus86_HTZ_Loop0A
	smpsPan             panLeft, $00
	smpsCall            Mus86_HTZ_Call04
	smpsPan             panCenter, $00
...
Mus86_HTZ_Loop0B:
	...
	smpsLoop            $00, $02, Mus86_HTZ_Loop0B

Mus86_HTZ_Loop0C:
	dc.b	nFs4, nFs4, nCs4, nCs4, nEb4, nEb4, nCs4, nCs4
	smpsLoop            $00, $02, Mus86_HTZ_Loop0C

Mus86_HTZ_Loop0D:
	dc.b	nF4, nF4, nC4, nC4, nD4, nD4, nC4, nC4
	smpsLoop            $00, $02, Mus86_HTZ_Loop0D

Mus86_HTZ_Loop0E:
	dc.b	nG4, nG4, nD4, nD4, nE4, nE4, nD4, nD4
	smpsLoop            $00, $02, Mus86_HTZ_Loop0E
	smpsLoop            $01, $04, Mus86_HTZ_Loop0B
	smpsNoteFill        $00
	smpsNop             $01
	smpsJump            Mus86_HTZ_FM2

Mus86_HTZ_Call08:
	dc.b	nA4, $03, nA4, nE4, nE4, nG4, nG4, nE4, nE4
	smpsLoop            $00, $04, Mus86_HTZ_Call08
	smpsReturn
...
Mus86_HTZ_Loop06:
	smpsCall            Mus86_HTZ_Call07
	smpsLoop            $00, $02, Mus86_HTZ_Loop06
	smpsAlterVol        $08
...
Mus86_HTZ_FM4:
	...
	smpsNoteFill        $06
	smpsCall            Mus86_HTZ_Call03
	smpsAlterNote       $04
	smpsCall            Mus86_HTZ_Call01
	smpsAlterVol        $06
	smpsSetvoice        $05
	smpsAlterNote       $02
	smpsAlterVol        $ED
...
Mus86_HTZ_Loop05:
	...
	smpsAlterNote       $00
	dc.b	$1C
	smpsLoop            $00, $02, Mus86_HTZ_Loop05
	smpsAlterVol        $06
	smpsAlterVol        $01
	smpsJump            Mus86_HTZ_FM4
...
Mus86_HTZ_Call0A:
	...
	smpsLoop            $00, $02, Mus86_HTZ_Call0A
	smpsReturn
...
Mus86_HTZ_Loop03:
	dc.b	nRst, $60
	smpsLoop            $00, $01, Mus86_HTZ_Loop03
	smpsSetvoice        $06
	smpsAlterVol        $EB
	smpsAlterPitch      $0C
	smpsModOff
...
Mus86_HTZ_Loop04:
	smpsCall            Mus86_HTZ_Call02
	dc.b	nE6, nF6, nG6
	smpsCall            Mus86_HTZ_Call02
	dc.b	nG6, nF6, nE6
	smpsLoop            $00, $02, Mus86_HTZ_Loop04
	smpsAlterVol        $09
	smpsAlterPitch      $F4
	smpsJump            Mus86_HTZ_FM5
...
Mus86_HTZ_PSG1:
	...
	smpsPSGAlterVol     $FF
	smpsCall            Mus86_HTZ_Call0A
	dc.b	nRst, $60
	smpsPSGvoice        $00
	smpsPSGAlterVol     $FF

Mus86_HTZ_Loop17:
	smpsCall            Mus86_HTZ_Call0B
	dc.b	nRst, $0C, nF5, nRst, $03, nF5, nRst, nRst, nF5, nRst, $09
	smpsCall            Mus86_HTZ_Call0B
	dc.b	nF5, $0C, nRst, $06, nF5, $1E
	smpsLoop            $00, $02, Mus86_HTZ_Loop17
	smpsPSGAlterVol     $01
	smpsJump            Mus86_HTZ_PSG1
...
Mus86_HTZ_Loop13:
	...
	smpsNoteFill        $03
	smpsCall            Mus86_HTZ_Call09

Mus86_HTZ_Loop11:
	dc.b	nG6, nG6, nD7, nG6, nC7, nG6, nB6, nG6
	smpsLoop            $00, $04, Mus86_HTZ_Loop11

Mus86_HTZ_Loop12:
	dc.b	nA6, nA6, nEb7, nA6, nD7, nA6, nC7, nA6
	smpsLoop            $00, $04, Mus86_HTZ_Loop12
	smpsCall            Mus86_HTZ_Call09
	smpsLoop            $01, $02, Mus86_HTZ_Loop13
	dc.b	nRst, $60
	smpsPSGAlterVol     $01

Mus86_HTZ_Loop14:
	dc.b	nC7, $03, nC7, nG7, nC7, nF7, nC7, nE7, nC7
	smpsLoop            $00, $02, Mus86_HTZ_Loop14

Mus86_HTZ_Loop15:
	dc.b	nBb6, nBb6, nF7, nBb6, nEb7, nBb6, nCs7, nBb6
	smpsLoop            $00, $02, Mus86_HTZ_Loop15

Mus86_HTZ_Loop16:
	dc.b	nA6, nA6, nE7, nA6, nD7, nA6, nC7, nA6
	smpsLoop            $00, $04, Mus86_HTZ_Loop16
	smpsLoop            $01, $04, Mus86_HTZ_Loop14
	smpsPSGAlterVol     $FF
	smpsJump            Mus86_HTZ_PSG2

Mus86_HTZ_Call09:
	dc.b	nA6, $03, nA6, nE7, nA6, nD7, nA6, nC7, nA6
	smpsLoop            $00, $04, Mus86_HTZ_Call09
	smpsReturn
...
Mus86_HTZ_Loop10:
	...
	smpsNoteFill        $03
	smpsPSGAlterVol     $FE
	smpsLoop            $00, $88, Mus86_HTZ_Loop10
	smpsJump            Mus86_HTZ_PSG3
...
Mus86_HTZ_Loop00:
	...
	smpsLoop            $00, $02, Mus86_HTZ_Loop00
...
Mus86_HTZ_Call06:
	...
	smpsLoop            $00, $02, Mus86_HTZ_Call06
	smpsReturn
